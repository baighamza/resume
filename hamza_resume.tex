...
\item Designed and implemented the program in \textbf{Python} and \textbf{PowerShell}, with data being stored in \textbf{Amazon S3} buckets and curated using  \textbf{SQL}
\end{tightemize}
\sectionsep
